...
gapminder <- read.csv(file= "data/gapminder5.csv", sep=",", stringsAsFactors=FALSE)
...
write_csv(gapminder07, "data/gapminder07.csv")
...
plot(gapminder07$lifeExp ~ gapminder07$gdpPercap,
     main="Life expectancy as a function of GDP Per capita",
     xlab="GDP Per capita",
